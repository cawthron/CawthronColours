...
Below area few examples of plots made using base `R` and [`ggplot2`](https://ggplot2.tidyverse.org/). We use the `gapminder` package to get some toy data and `rnatrualearch` to get a map of New Zealand.
